...
python src/train.py
This takes about 1–3 minutes on CPU. It creates models/chatbot.pt and models/vocab.json.

Windows shortcut: From the project folder you can run .\run.bat instead — it creates the venv, installs packages, trains if needed, and starts chat.
